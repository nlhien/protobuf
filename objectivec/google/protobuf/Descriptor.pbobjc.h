...
@property(nonatomic, readwrite) BOOL javaGenerateEqualsAndHash GPB_DEPRECATED_MSG("google.protobuf.FileOptions.java_generate_equals_and_hash is deprecated (see descriptor.proto).");

@property(nonatomic, readwrite) BOOL hasJavaGenerateEqualsAndHash GPB_DEPRECATED_MSG("google.protobuf.FileOptions.java_generate_equals_and_hash is deprecated (see descriptor.proto).");
/**
